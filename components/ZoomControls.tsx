...
export default function zoomControls({
    ...
    //define o raio de um circulo invisível no qual os botões de zoom serão posicionados
    ...
    return (
        <View style = {{flex: 1, padding: 10}}>
            ...
            {zoomOptions.map ((z,i) => {
                //calcula a posição angular de cara botão em volta de um circulo
                ...
                return (
                    <Animated.View
                        key = {i}
                        // animação de entrada com atraso crescente
